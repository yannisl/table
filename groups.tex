...
\bgroup\cxset{palette spring onion}%
...
\begin{longtable}[l]{l%serial 
                  ...
                  l|% 
                  l|}%
\caption{Group Codes} \label{tbl:groups}\\
\rowcolor{thetableheadbgcolor}\rowcolor{thetableheadbgcolor}\rowcolor{thetableheadbgcolor}\multicolumn{1}{|>{\color{thetableheadcolor}\bfseries}c|}{CODE}  &\multicolumn{1}{|>{\color{thetableheadcolor}\bfseries}c|}{SHORT DESCRIPTION}  &\multicolumn{1}{|>{\color{thetableheadcolor}\bfseries}c|}{LONG DESCRIPTION}  \\ 
\rowcolor{thetableheadbgcolor}\multicolumn{1}{|>{\color{thetableheadcolor}\bfseries}c|}{A}  &\multicolumn{1}{|>{\color{thetableheadcolor}\bfseries}c|}{B}  &\multicolumn{1}{|>{\color{thetableheadcolor}\bfseries}c|}{C}  \\ 
\rowcolor{thetableheadbgcolor}\multicolumn{1}{|>{\color{thetableheadcolor}\bfseries}c|}{D}  &\multicolumn{1}{|>{\color{thetableheadcolor}\bfseries}c|}{E}  &\multicolumn{1}{|>{\color{thetableheadcolor}\bfseries}c|}{F}  \\ 
\endfirsthead
